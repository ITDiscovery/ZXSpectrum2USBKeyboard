/*
  ...
  |_____|_| |_| |_|\__,_|_|\__,_|\__\___/|_|       \_/  |_____|
              ...
              Daniel Jos� Viana, danjovic@hotmail.com
...
_KEY_NONE,         // 0x00   
_CS + _KEY_9,      // 0x01  F9   (GRAPHICS)
_KEY_NONE,         // 0x02  
_KEY_NONE,         // 0x03  F5
_CS + _KEY_3,      // 0x04  F3   (TRUE VIDEO)
_CS + _KEY_1,      // 0x05  F1   (EDIT)
_CS + _KEY_2,      // 0x06  F2   (CAPS LOCK)
_KEY_NONE,         // 0x07  F12           
_KEY_NONE,         // 0x08                
_KEY_NONE,         // 0x09  F10           
_KEY_NONE,         // 0x0A  F8            
_KEY_NONE,         // 0x0B  F6            
_CS + _KEY_4,      // 0x0C  F4   (INVERSE VIDEO)            
_CS + _SS,         // 0x0D  TAB  (EXTENDED MODE)          
_SS + _KEY_P,      // 0x0E  APOSTROPHE (ASPAS)
_KEY_NONE,         // 0x0F                
_KEY_NONE,         // 0x10                
...
_KEY_NONE,         // 0x47                
_KEY_NONE,         // 0x48                
_SS + _KEY_M,      // 0x49  DOT       (SS + M)
_SS + _KEY_O,      // 0x4A  SEMICOLON (SS + O)
_KEY_L   ,         // 0x4B  L             
_KEY_NONE,         // 0x4C  CCCEDIL    �
_KEY_P,            // 0x4D  P             
_SS + _KEY_J,      // 0x4E  MINUS      (SS + J)
_KEY_NONE,         // 0x4F  
_KEY_NONE,         // 0x50  
_SS + _KEY_V,      // 0x51  SLASH      (SS + V)
_KEY_NONE,         // 0x52  TILDE         ~
_KEY_NONE,         // 0x53  
_KEY_NONE,         // 0x54  ACUTE         `
_SS + _KEY_L,      // 0x55  EQUAL       (SS + L)
_KEY_NONE,         // 0x56  
_KEY_NONE,         // 0x57  
_CS + _KEY_2,      // 0x58  CAPS    (CAPS SHIFT + 2)
...
_KEY_4,            // 0x6B  KP4
_KEY_7,            // 0x6C  KP7
_SS + _KEY_M,      // 0x6D  KPDOT  (SS + M) 
_KEY_NONE,         // 0x6E  
_KEY_NONE,         // 0x6F  
_KEY_0,            // 0x70  KP0
_SS + _KEY_N,      // 0x71  KPCOMMA (SS + N) 
_KEY_2,            // 0x72  KP2
_KEY_5,            // 0x73  KP5
_KEY_6,            // 0x74  KP6
_KEY_8,            // 0x75  KP8
_CS + _KEY_SP,     // 0x76  ESC  (CS + SPACE)
_KEY_NONE,         // 0x77  NUM
_KEY_NONE,         // 0x78  F11
_CS + _KEY_K,      // 0x79  KPPLUS (SS + K)
_KEY_3,            // 0x7A  KP3
_SS + _KEY_J,      // 0x7B  KPMINUS  (SS + J)
...
_KEY_NONE,         // 0x38  WWW_KEY_Back      (Multimedia)                   
_KEY_NONE,         // 0x39                     
...
_KEY_NONE,         // 0x49                     
_SS + _KEY_V,      // 0x4A  Keypad SLASH  (SS + V)                   
_KEY_NONE,         // 0x4B                     
_KEY_NONE,         // 0x4C                     
...
_KEY_NONE,         // 0x69  END
_KEY_NONE,         // 0x6A  
_CS + _KEY_5,      // 0x6B  LEFT Arrow (CS + 5)
_KEY_NONE,         // 0x6C  HOME 
_KEY_NONE,         // 0x6D  
_KEY_NONE,         // 0x6E  
_KEY_NONE,         // 0x6F           
...
_CS + _KEY_6,      // 0x72  DOWN Arrow (CS + 6)                      
_KEY_NONE,         // 0x73                       
_CS + _KEY_8,   // 0x74  RIGHT Arrow   (CS + 8)                  
_CS + _KEY_7,   // 0x75  UP Arrow      (CS + 7)                
_KEY_NONE,         // 0x76                        
_KEY_NONE,         // 0x77                           
_KEY_NONE,         // 0x78                        
_KEY_NONE,         // 0x79                       
